...
namespace Bones\CoreBundle\Model\om;
...
use Bones\CoreBundle\Model\ArticlePeer;
use Bones\CoreBundle\Model\map\ArticleTableMap;
...
abstract class BaseArticlePeer
{
    ...
    const TABLE_NAME = 'bones_article';

    /** the related Propel class for this table */
    const OM_CLASS = 'Bones\\CoreBundle\\Model\\Article';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Bones\\CoreBundle\\Model\\map\\ArticleTableMap';
    ...
    const ID = 'bones_article.id';

    /** the column name for the title field */
    const TITLE = 'bones_article.title';

    /** the column name for the content field */
    const CONTENT = 'bones_article.content';

    /** the column name for the meta_columns field */
    const META_COLUMNS = 'bones_article.meta_columns';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Content', 'MetaColumns', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'content', 'metaColumns', ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID, ArticlePeer::TITLE, ArticlePeer::CONTENT, ArticlePeer::META_COLUMNS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'CONTENT', 'META_COLUMNS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'content', 'meta_columns', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Content' => 2, 'MetaColumns' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'metaColumns' => 3, ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID => 0, ArticlePeer::TITLE => 1, ArticlePeer::CONTENT => 2, ArticlePeer::META_COLUMNS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'CONTENT' => 2, 'META_COLUMNS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'meta_columns' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArticlePeer::META_COLUMNS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.content');
            $criteria->addSelectColumn($alias . '.meta_columns');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to bones_article
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseArticlePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Bones\CoreBundle\Model\map\ArticleTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the bones_article table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
